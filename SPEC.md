...
|---|---|---|---|
| `domain` | varied | between-situation | academic and professional task types with concrete finished outputs, spanning threat-model population strata; restricted to model-knowledge-sufficient tasks — personal and generative ideation-natural domains are scoped out (D-012–D-014; L-004) |
